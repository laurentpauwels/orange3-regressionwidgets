...
from Orange.widgets.gui import auto_commit, button, checkBox, comboBox, lineEdit
from Orange.data import Table, Domain
from Orange.data.pandas_compat import table_to_frame
from PyQt6.QtWidgets import QTextEdit, QPushButton, QComboBox, QDoubleSpinBox, QLabel,QFormLayout
